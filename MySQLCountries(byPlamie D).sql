...
SELECT countries.name AS country_name, COUNT(cities.name) AS number_cities
FROM countries
...
SELECT countries.name AS countries , languages.language AS languages , languages.percentage 
FROM languages
